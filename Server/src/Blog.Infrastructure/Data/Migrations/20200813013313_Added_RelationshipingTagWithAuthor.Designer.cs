...
namespace Medium.Infrastructure.Data.Migrations
{
    ...
    [Migration("20200813013313_Added_RelationshipingTagWithAuthor")]
    partial class Added_RelationshipingTagWithAuthor
    {
            ...
            modelBuilder.Entity("Medium.Core.Domain.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmedEmail = true,
                            CreatedAt = new DateTime(2020, 8, 12, 22, 33, 0, 0, DateTimeKind.Unspecified),
                            Deactivated = false,
                            Deleted = false,
                            Email = "admin.master@email.com",
                            FirstName = "Administrador",
                            LastName = "Master",
                            Password = "D6PCwii9KSmoyUnUUPBtQsgpla70RLprkdwiqIYwFug=",
                            Salt = "L+FUqju1urg=",
                            UpdatedAt = new DateTime(2020, 8, 12, 22, 33, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Medium.Core.Domain.PostTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Id = new Guid("fb3c0380-0634-4140-a961-ce5f79c47f81")
                        });
                });

            modelBuilder.Entity("Medium.Core.Domain.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Medium.Core.Domain.PostTag", b =>
                {
                    ...
                    b.HasOne("Medium.Core.Domain.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
